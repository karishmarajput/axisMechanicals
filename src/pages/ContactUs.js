...
function ContactUs(){
    return(
        ...
        <div className="contactText">
            ...
            <h5>
            We love our customers, Call us today to book your appointment or send us an email.
            </h5>
        </div>
        </div>
        <div className="contactUsDiv">
            <div>
                ...
                <div className="contactMap">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2610.396691091432!2d-122.8432431!3d49.13609220000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8db63a8fa25c819d%3A0xe371662de0f23837!2sAxis%20Mechanical%20ltd!5e0!3m2!1sen!2sin!4v1707925879770!5m2!1sen!2sin!1m3!1d5!2d-122.8432431!3d49.13609220000001!1m3!1d5!2d-122.8432431!3d49.13609220000001" width="100%" height="500px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                </div>
                ...
                <p><FontAwesomeIcon icon={faMapMarkerAlt} /> Surrey, British Columbia, Canada</p>
                 ...
                 <div class="findUsDiv">
                 <h1 class="axisMechanicsContact">
                 <span class="findUsPadding">FIND US</span></h1>
                 <div class="findUs findContact">
                 ...
                 <div className='chatWithUs contactUsChatWithUs'>
