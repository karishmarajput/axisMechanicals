...
function HomeServices(){
 return(
    <div className="HomeServicesContainer">
        ...
        <img src="/images/HomeServices/plumbing.png" width={'70px'} height={'70px'}></img> <h1>PLUMBING</h1>
        <p>Professional and Trusted Solutions for all <br/> your New Construction Needs</p>
        </div>
        <div className='homeService1'>
            <img src="/images/HomeServices/heating.png" width={'70px'} height={'70px'}></img> <h1>HEATING</h1>
            <p >Professional Heating System Installation, Repair, <br/>and Maintenance at Your Doorstep</p></div>
       
        <div className='homeService3'>
        <img src="/images/HomeServices/gasFitting.png" width={'70px'} height={'70px'}></img> <h1>GAS FITTING</h1>
